...
# This file is modified version of the https://github.com/phuhl/notify-send.py
# Licensed under the MIT License. See https://github.com/phuhl/notify-send.py/blob/master/LICENSE
...
class NotifySendPy:
    ...
    def close(self, n):
        self.actions_out.append('closed')
        self.loop.quit()

    def action(self, n, text):
        self.actions_out.append(text)
        self.loop.quit()
